...
from corindagpt.src.components.phase_manager import PhaseManager
from corindagpt.src.components.input_handler import InputHandler
from corindagpt.src.components.state_machine import StateMachine, State
from corindagpt.src.services.voice_to_text import VoiceRecorder, TranscriptionService
try:  # optional import of SDPressHoldRecorder symbol
    from corindagpt.src.services.voice_to_text import SDPressHoldRecorder  # type: ignore
except Exception:  # pragma: no cover
    SDPressHoldRecorder = None  # type: ignore
from corindagpt.src.services.prompt_loader import load_prompt_for_phase, render_prompt
from corindagpt.src.services import gpt as gpt_service
from corindagpt.src.services import tts as tts_service
...
async def run() -> None:
    ...
    # Setup recorder/transcriber (prefer SoundDevice on Windows if available)
