...
try:
    from corindagpt.src.utils.initialization import load_config  # when run from repo root
except Exception:
    from src.utils.initialization import load_config  # fallback if run as module
