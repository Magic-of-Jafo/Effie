...
def test_synthesize_success() -> None:
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        assert request.url.path.endswith("/text-to-speech/EXAVITQu4vr4xnSDxMaL")
        return httpx.Response(200, content=b"\x00\x00" * 80, headers={"Content-Type": "application/octet-stream"})
