...
class InputHandler:
    ...
    def __init__(
        ...
        *,
        ...
        on_transition_trigger: Optional[KeyHandler] = None,
    ) -> None:
        self.loop = loop
        ...
        # Transition input
        self.transition_hotkey_name = (transition_hotkey_name or "").lower() or None
        self.transition_long_press_ms = int(max(0, transition_long_press_ms))
        self.on_transition_trigger = on_transition_trigger
    ...
    def _is_transition_hotkey(self, key: object) -> bool:
        if not self.transition_hotkey_name:
            return False
        name = str(key).lower()
        return self.transition_hotkey_name in name
